...
def backuptvdb():
	try:
                ...
                cur.execute('CREATE TABLE IF NOT EXISTS backupshows(TShow TEXT, Episode TEXT, Season INT, Enum INT, Tnum INT, Summary TEXT, Link TEXT)')
                sql.commit()
        try:
...
def restoretvdb():
        ...
        sql.commit()
        cur.execute("INSERT INTO shows SELECT * FROM backupshows")
        sql.commit()
